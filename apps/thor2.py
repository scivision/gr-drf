...
parser.add_option("-c", "--centerfreq", dest="centerfreq", action="store", type="float", default=126.2e6,
...
sampler_util.write_metadata_drf(op.dir0,1,[op.centerfreq],op.starttime,dtype="<i2",itemsize=4,sr=op.samplerate,extra_keys=["usrp_ip"],extra_values=[op.mboard])
